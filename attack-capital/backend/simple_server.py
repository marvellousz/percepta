...
print(f"DEBUG: GEMINI_API_KEY (first 6 chars): {api_key[:6]}...")  # Debug print
...
async def generate_response(message: str, username: str, agent_name: str = "support-agent", context: Optional[str] = None) -> str:
    try:
        ...
        # Create the prompt with agent profile and context
        ...
        model = genai.GenerativeModel("gemini-2.0-flash")  # Using the pro model
